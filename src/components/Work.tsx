...
const projects = [
  {
    title: "QuickCompare",
    category: "Real-Time E-Commerce Scraping & Price Aggregation Platform",
    tools: "Python · Flask · Cloudflare Workers · BeautifulSoup · REST APIs",
  ...
  {
    title: "3D Multiplayer Battle Game",
